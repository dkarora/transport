<?php
	...
	{
		var $components = array('SlugGenerator');
		...
		function viewWorkshop($workshop)
		{
			if (!$workshop['Workshop']['unlisted'])
				...
				return array('controller' => 'workshops', 'action' => 'view', $this->_alphaID($workshop['Workshop']['id']), $this->SlugGenerator->generate($workshop['Detail']['name']));
		}
		 ...
		 */
		function _alphaID($in, $to_num = false, $pad_up = 8, $passKey = null)
		{
			$passKey = Configure::read('Security.salt');
