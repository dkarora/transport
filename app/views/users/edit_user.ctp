...
$rows = array(
    ...
    'Work Information',
    'User.affiliation' => array('escape' => false, 'after' => '<br />' . $html->tag('span', 'For no work affiliation, use "Private".', array('class' => 'italics'))),
    'User.email' => array(),
...
$fOpts = array ('controller' => 'users', 'action' => 'edit_user', $user_id);
